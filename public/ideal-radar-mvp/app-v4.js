...
function decision(){return shell(`<div class="eyebrow">FINAL CHOICE</div><h1>더 알아가고 싶나요?</h1><p>당신의 선택은 상대에게 바로 공개되지 않아요.</p><span class="ticket">🎟 보유 티켓 ${state.tickets}장</span><div class="decision"><button class="yes" data-action="choose-yes">더 알아가고 싶어요 · 🎟2</button><button class="no" data-action="end">여기까지</button></div>`)}
